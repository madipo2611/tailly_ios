...
struct ProfileView: View {
    ...
    private func load() async { do { struct Response: Decodable { let me: Me }; me = try await api.perform(GraphQLOperations.me) as Response } catch { self.error = error.localizedDescription } }
}
